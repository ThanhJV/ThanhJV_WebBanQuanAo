                ...
                <div class="modal-body">
                    <form:form id="edit-form" modelAttribute="sp" method="post" action="/admin/san-pham/store" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label class="form-label" for="idCauLacBo">Câu lạc bộ</label>
                                    <form:select class="form-select form-select-sm" id="idCauLacBo" path="idCauLacBo">
                                        <c:forEach items="${listCauLacBo}" var="clb">
                                            <option value="${clb.id}">${clb.ten}</option>
                                        </c:forEach>
                                    </form:select>
                                </div>
                            </div>
...
<%--                        </c:if>--%>
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            const idCauLacBoSelect = document.getElementById('idCauLacBo');
    ...
    $(".update-button").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#idCauLacBo").val(data.idCauLacBo);
