...
<div class="container mt-3">
    <h1 class="text-center">Quản Lý Câu Lạc Bộ</h1>
    ...
    <div class="row mt-3">
        <div class="col-9">
            <table class="table table-bordered mt-3 text-center">
                ...
                <tbody>
                <c:forEach varStatus="index" items="${clbPage.content}" var="th">
                    <tr>
                        <td>${index.index + clbPage.number * clbPage.size + 1}</td>
                        <td>${th.ten}</td>
                        <td>
        ...
        <div class="col-3 mt-4">
            <form:form id="edit-form" modelAttribute="clb" method="post" action="/admin/cau-lac-bo/store">
    ...
    <div class="mt-3">
        <div class="text-center">
            <c:if test="${clbPage.totalPages > 1}">
                <ul class="pagination">
                    <li class="page-item <c:if test="${clbPage.number == 0}">disabled</c:if>">
                        <a class="page-link" href="?page=1">First</a>
                    </li>
                    <c:forEach var="i" begin="1" end="${clbPage.totalPages}">
                        <li class="page-item <c:if test="${clbPage.number + 1 == i}">active</c:if>">
...
<script>
    $(".update-button").click(function () {
        ...
        $.ajax({
            url: "/admin/cau-lac-bo/get/" + id,
            type: "GET",
            success: function (data) {
                $("#ten").val(data.ten);
                $("#trang_thai").val(data.trang_thai);

                $("#edit-form").attr("action", "/admin/cau-lac-bo/update/" + id);
            },
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        updateButtons.forEach(function (button) {
            button.addEventListener("click", function () {
                ...
                modalTitle.textContent = "Cập Nhật Câu Lạc Bộ";
        ...
        clickClose.addEventListener("click", function () {
            ...
            modalTitle.textContent = "Thêm Câu Lạc Bộ";

            $("#edit-form").trigger("reset");
            $("#edit-form").attr("action", "/admin/cau-lac-bo/store");
